...
----------------------------------------------------------------
1. Draw ER Diagram for Library Information System discussed during Session.

2. Create all tables of Library as described and mentioned in Slides.
...
3. Insert sample data in LIS tables by using SQL files.
