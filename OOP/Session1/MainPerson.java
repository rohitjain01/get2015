...
public class MainPerson
{
   public static void main(String args[])
   {
	   ...
	   int numCourses;
	   int i, j;
	   for(i=0; i<numPerson; i++)//loop to store the information of student 
	   {
		   ...
		   for(j=0; j<numCourses; j++)//loop to store the courses for particular student
		   {
	   ...
	   for(i=0; i<numPerson; i++)//loop to show the complete information of student
	   {
	       System.out.println("\n Student "+(i+1)+" information is:"+student[i].toString());
	       System.out.print("Courses are : ");
	      
	    	   courses=student[i].getCourses();
	    	   for(j=0; j<courses.length; j++)//loop to show the courses of particular student
