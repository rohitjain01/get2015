...
/**
 * Class that stores all methods to perform functions on train data for booking
 * ticket
 * 
 * @author Akshat
 *
...
public class Processing {
	...
	public static List<PassengerTrain> selectedListOfPassenger = new ArrayList<PassengerTrain>();
	// stores the filtered list of passenger train
	public static List<GoodsTrain> selectedListOfGoods = new ArrayList<GoodsTrain>();
	// stores the filtered list of goods train

	// method to show passenger train details
	public void displayAllPassengerTrains(List<PassengerTrain> selectedList) {
	...
	// method to return the filtered list of goods train according to source and
	// destination
	public List<GoodsTrain> goodsTrainBtwStations() {
		return selectedListOfGoods;
	}

	// this method returns true if the specified train by the passenger is
	// available
