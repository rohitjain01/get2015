...
public class TemperatureConverterServiceLocator extends org.apache.axis.client.Service implements com.metacube.converter.TemperatureConverterService {
    ...
    private java.lang.String TemperatureConverter_address = "http://localhost:8080/TemperatureWebService/services/TemperatureConverter";
    ...
    public com.metacube.converter.TemperatureConverter getTemperatureConverter() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.converter.TemperatureConverter getTemperatureConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.converter.TemperatureConverterSoapBindingStub _stub = new com.metacube.converter.TemperatureConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.converter.TemperatureConverter.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.converter.TemperatureConverterSoapBindingStub _stub = new com.metacube.converter.TemperatureConverterSoapBindingStub(new java.net.URL(TemperatureConverter_address), this);
                _stub.setPortName(getTemperatureConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://converter.metacube.com", "TemperatureConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://converter.metacube.com", "TemperatureConverter"));
        }
